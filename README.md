...
The API connects to an external Docker network (`lanbooking-network`) to allow inter-service communication with other services. Before starting the services for the first time, create the network:
